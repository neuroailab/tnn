...
def residual_add(inp, res_inp, dtype=tf.float32, kernel_initializer='xavier', kernel_init_kwargs=None, strides=[1,1,1,1], padding='SAME', batch_norm=False, is_training=False, init_zero=None, batch_norm_decay=0.9, batch_norm_epsilon=1e-5):
    if inp.shape.as_list() == res_inp.shape.as_list():
        ...
        initializer = tfutils.model.initializer(kind=kernel_initializer, **kernel_init_kwargs)
